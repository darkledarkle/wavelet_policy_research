...
from diffusion_policy.model.diffusion.wavelet_for_diffusion import WaveletForDiffusion
from diffusion_policy.model.diffusion.mask_generator import LowdimMaskGenerator
from diffusion_policy.model.diffusion.wavelet_components import causal_moving_average

class DiffusionWaveletLowdimPolicy(BaseLowdimPolicy):
    def __init__(self, 
